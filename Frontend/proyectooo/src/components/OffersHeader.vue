    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
      <div class="flex justify-between items-center">
        ...
        <nav class="flex items-center space-x-8">
          ...
          <a href="#" @click.prevent="goToProducts" class="text-gray-700 hover:text-blue-600 font-medium text-sm transition-colors cursor-pointer">Productos</a>
          <a href="#" style="color: #2563EB;" class="font-medium text-sm cursor-pointer">Ofertas</a>
        ...
        <div class="flex items-center space-x-4">
          <div class="relative">
            <label for="offers-header-search" class="sr-only">Buscar productos</label>
            <input
              id="offers-header-search"
              type="text"
          ...
          <button 
            type="button"
            class="relative p-2 text-white rounded-lg hover:bg-blue-700 transition-colors !rounded-button" 
